...
def build_libero_env(img_h, img_w, env_meta_fn, env_name, task_name,
                     render_gpu_ids=-1, vec_env_num=1, seed=0, env_idx_start_end=None):
    """
    Build the LIBERO rollout environments. See `atm.utils.env_utils.build_env` for the argument
    semantics; this function holds everything that needs robosuite / libero to be installed.
    """
